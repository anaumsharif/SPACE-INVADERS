...
bulletImg = pygame.image.load('C:\\Users\\HP\\CODE\\VS-CODE\\PYTHON\\GAMES\\images\\SPACE INVADERS\\bullet.png')
bulletX = 0
bulletY = 480
bulletX_change = 0
bulletY_change = 10
...
while running:
    ...
    for i in range(num_of_enemies):
        ...
        if collision:
            explosionSound = mixer.Sound("C:\\Users\\HP\\CODE\\VS-CODE\\PYTHON\\GAMES\\images\\SPACE INVADERS\\explosion.wav")
            explosionSound.play()
            bulletY = 480
            bullet_state = "ready"
            score_value += 1
